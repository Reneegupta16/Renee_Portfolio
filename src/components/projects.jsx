...
<div className='bg-[#0d2438] text-white'>
  <div className='grid grid-cols-3 gap-1 justify-items-center'>
    <Projects image={'https://react-tailwindcss-portfolio.netlify.app/static/media/developer-dark.3f07bd13.svg'} title={'Dental Website'} description={'Responsive Website'} />
