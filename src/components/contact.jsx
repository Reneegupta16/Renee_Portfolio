...
export function Contactpage() {
    const contacts = [
        {
            id: 1,
            name: 'Sector-16, Rohini, New Delhi, India, Asia',
            icon: <FiMapPin />,
        },
        {
            id: 2,
            name: 'Reneetwinkle1617@gmail.com',
            icon: <FiMail />,
        },
        {
            id: 3,
            ...
            <div className="w-full lg:w-1/2 text-white">
                <div className="leading-loose">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            className="w-full mt-6 px-4 py-2.5 text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-1 focus:ring-indigo-900 rounded-lg duration-500"
